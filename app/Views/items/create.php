    ...
    <div class="card">
        <div class="card-header">
            <div class="row my-3 d-flex align-items-center justify-content-between">
                <div class="col col-md-7"><b class="float-end">TAMBAH BARANG</b></div>
        ...
        <div class="card-body">
            <form method="post" action="<?= url_to('items') ?>" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="item_jenis" class="form-control" placeholder="Masukan Jenis Barang" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Kode Barang</label>
                    <div class="col-sm-8">
                        <input type="number" name="item_kode" class="form-control" placeholder="Masukan Kode Barang" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Jumlah Barang</label>
                    <div class="col-sm-8">
                        <input type="number" name="item_jumlah" class="form-control" placeholder="Masukan Jumlah Barang" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Harga Jual</label>
                    <div class="col-sm-8">
                        <input type="number" name="item_harga" class="form-control" placeholder="Masukan Harga Jual" />
                    </div>
                </div>
                <div class="row mb-3">
