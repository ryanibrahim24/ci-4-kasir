    ...
    <div class="card">
        <div class="card-header">
            <div class="row my-3 d-flex align-items-center justify-content-between">
                <div class="col col-md-7"><b class="float-end">EDIT KARYAWAN</b></div>
        ...
        <div class="card-body">
            <form method="post" action="/users/update/<?= $record['id'] ?>" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Nama Pegawai</label>
                    <div class="col-sm-8">
                        <input type="text" name="user_name" class="form-control" placeholder="Masukan Nama Pegawai" value="<?= $record['name'] ?>" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Username</label>
                    <div class="col-sm-8">
                        <input type="text" name="user_username" class="form-control" placeholder="Masukan Username" value="<?= $record['username'] ?>" />
                    </div>
                </div>
                <!-- <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="email" name="user_email" class="form-control" placeholder="Masukan Email" value="<?= $record['email'] ?>" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">KTP</label>
                    <div class="col-sm-8">
                        <input type="number" name="user_ktp" class="form-control" placeholder="Masukan No KTP" value="<?= $record['ktp'] ?>" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Telephone</label>
                    <div class="col-sm-8">
                        <input type="number" name="user_phone" class="form-control" placeholder="Masukan No Telephone" value="<?= $record['phone'] ?>" />
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <label class="col-sm-4 col-label-form">Status</label>
                    <div class="col-sm-8">
